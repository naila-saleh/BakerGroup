            ...
            <Grid container spacing={1} sx={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', height: '100%'}}>
                <Grid size={{xl: 5, lg: 5, md: 12, sm: 12, xs: 12}} sx={{display: 'flex', flexDirection: 'column', alignItems: {xl:'flex-start', lg: 'flex-start', md: 'center', sm: 'center', xs: 'center'}, gap: 2, textAlign: {xl: 'start', lg: 'start', xs: 'center'}, paddingX: {md: 10, sm: 5, xs: 2}, color: 'white'}}>
                    ...
                    <Box sx={{display: 'flex', gap: 1, marginTop: {md: 3, xs: 1}, flexDirection: {xl: 'row', lg: 'row', md: 'row', sm: 'column', xs: 'column'}}}>
                        ...
                        <Link component={RouterLink} target={'_blank'} to={'https://www.instagram.com/liferesponse_200/'} sx={{color: 'inherit', fontSize: {xl: '18px', md: '15px', xs: '13px'}, padding: '10px'}}>{t('Follow Instagram')}</Link>
                    </Box>
                    <Box sx={{display: 'flex', flexDirection: {sm: 'row', xs: 'column'}, gap: {xl: 8, md: 4, xs: 2}, marginTop: {md: 5, xs: 1}, marginBottom: {md: 0, xs: 2}}}>
                        <Box sx={{display: 'flex', flexDirection: 'column'}}>
                            ...
                            <Typography component={'span'} sx={{color: '#A6BCBE', fontSize: {xl: '14px', md: '14px'}}}>{t('Unique Styles')}</Typography>
                        </Box>
                        <Box sx={{display: 'flex', flexDirection: 'column'}}>
                            <Typography component={'span'} sx={{color: 'inherit', fontSize: {lg: '20px', md: '18px'}}}>5000+</Typography>
                            <Typography component={'span'} sx={{color: '#A6BCBE', fontSize: {xl: '14px', md: '14px'}}}>{t('Happy Customers')}</Typography>
                        </Box>
                        <Box sx={{display: 'flex', flexDirection: 'column'}}>
                            <Typography component={'span'} sx={{color: 'inherit', fontSize: {lg: '20px', md: '18px'}}}>300+</Typography>
                            <Typography component={'span'} sx={{color: '#A6BCBE', fontSize: {xl: '14px', md: '14px'}}}>{t('Certified Outlets')}</Typography>
                        </Box>
                    </Box>
                </Grid>
                    ...
                    <Box sx={{display: 'flex', flexDirection: {md: 'row', xs: 'column'}, gap: {xl: 3, lg: 2, md: 3, sm: 3}, justifyContent: 'flex-start', alignItems: 'center', height: '100%', color: 'white'}}>
                        <Box sx={{position: 'relative'}}>
                            ...
                            <Box className={style.overlay} sx={{display: 'flex', gap: {xl: 15, lg: 5, md: 15}, alignItems: 'flex-end', justifyContent: 'space-between', padding: '30px 20px', position: 'absolute', bottom: 0}}>
                                <Typography component={'span'} sx={{fontSize: '25px'}}>{t('Bed Room')}</Typography>
                                <Box sx={{display: 'flex', gap: 1, alignItems: 'center'}}>
                                    <Typography component={'span'} sx={{fontSize: '20px', fontWeight: '500'}}>1200+</Typography>
                                    <Typography component={'span'} sx={{fontSize: '18px'}}>{t('item')}</Typography>
                                </Box>
                            </Box>
                        </Box>
                        <Box sx={{position: 'relative'}}>
                            ...
                            <Box className={style.overlay} sx={{display: 'flex', gap: {xl: 15, lg: 5, md: 15}, alignItems: 'flex-end', justifyContent: 'space-between', padding: '30px 20px', position: 'absolute', bottom: 0}}>
                                <Typography component={'span'} sx={{fontSize: '25px', transform: {md: 'rotate(-90deg)', xs: 'none'}, whiteSpace: {md: 'nowrap', xs: 'none'}, position: {md: 'absolute'}, bottom: {md: 75}, left: {md: 23}}}>{t('Living Room')}</Typography>
                        ...
                        <Box sx={{position: 'relative'}}>
                            ...
                            <Box className={style.overlay} sx={{display: 'flex', gap: {xl: 15, lg: 5, md: 15}, alignItems: 'flex-end', justifyContent: 'space-between', padding: '30px 20px', position: 'absolute', bottom: 0}}>
                                <Typography component={'span'} sx={{fontSize: '25px', transform: {md: 'rotate(-90deg)', xs: 'none'}, whiteSpace: {md: 'nowrap', xs: 'none'}, position: {md: 'absolute'}, bottom: {md: 80}, left: {md: 10}}}>{t('Waiting Room')}</Typography>
                                <Box sx={{display: {md: 'none', xs: 'flex'}, gap: 1, alignItems: 'center'}}>
                                    <Typography component={'span'} sx={{fontSize: '20px', fontWeight: '500'}}>1200+</Typography>
                                    <Typography component={'span'} sx={{fontSize: '18px'}}>{t('item')}</Typography>
                                </Box>
